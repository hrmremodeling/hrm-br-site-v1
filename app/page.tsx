...
const process = [
  "Initial conversation and project review",
  "On-site visit and estimate",
  "Scope, selections, and scheduling",
  "Construction with clear communication",
  "Final walkthrough and completed space",
];
...
const trustPoints = [
  "Real remodeling projects from local homes",
  ...
  "Basement finishing and custom built‑ins",
  "Deck construction, windows, and exterior improvements",
];
...
export default function HRMWebsitePreview() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <div className="relative h-[560px] w-full overflow-hidden">
          ...
          <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-center px-6 text-white">
            ...
            <div className="mt-10 flex flex-wrap gap-5">
              <Button className="rounded-xl bg-white px-6 py-5 text-base text-black hover:bg-white/90">
                Request a Free Estimate
              </Button>
              <Button
                variant="secondary"
                className="rounded-xl border border-white bg-transparent px-6 py-5 text-base text-white hover:bg-white/10"
              >
                View Our Projects
              </Button>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-8 text-base text-white/90">
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} /> Kitchens
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} /> Bathrooms
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} /> Basements
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} /> Decks
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} /> Windows & Doors
              </div>
            </div>
          </div>
        </div>
            ...
            <CardContent className="grid gap-6 p-6 md:grid-cols-[1.15fr_0.85fr] md:p-8">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-neutral-500">
                  Trusted Local Remodeling Contractor
                </p>
                <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
                  {["Honesty", "Integrity", "Quality Craftsmanship"].map((item) => (
                    <div
                      key={item}
                      className="rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3 text-center text-sm font-semibold text-neutral-900"
                    >
                      {item}
                    </div>
                  ))}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {highlights.map((item) => (
                  <div
                    key={item}
                    className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 text-sm font-semibold text-neutral-800"
                  >
                    {item}
                  </div>
                ))}
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 pt-16 pb-20 md:pt-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-neutral-600">
            With a quarter-century of expertise, HRM Building And Remodeling LLC is your trusted
            partner for home transformations in the Vernon area. Specializing in kitchen remodeling,
            bathroom renovations, basement finishing, decks, windows, and doors, our team brings
            visions to life with unparalleled skill. From initial design to final installation, we
            provide a seamless, full-service experience. Our commitment to honesty, integrity, and
            quality craftsmanship ensures every project is completed to the highest standard,
            delivering beautiful and lasting results.
          </p>
        </div>
            ...
            <Card className="rounded-[2rem] border-0 bg-neutral-950 text-white shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="mt-4 text-sm leading-7 text-neutral-300">
                  Not every bathroom needs a full renovation. We offer efficient bathroom upgrades for homeowners who want a dramatic improvement without a long multi-week project. The focus stays on proper installation, clean finishes, and long-term value.
                </p>
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  {bathroomUpgradeFeatures.map((item) => (
                    <div key={item} className="flex items-start gap-3 rounded-2xl bg-white/5 px-4 py-3 text-sm text-neutral-200">
            ...
            <Card className="rounded-[2rem] border-0 bg-neutral-100 shadow-md shadow-black/5">
              <CardContent className="p-8">
                ...
                <p className="mt-4 text-sm leading-7 text-neutral-600">
                  Kitchens are one of the biggest investments you can make in your home. We focus on layouts, finishes, and details that improve function, increase storage, and create a space your family will enjoy every day.
                </p>
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  {kitchenFeatures.map((item) => (
                    <div key={item} className="flex items-start gap-3 rounded-2xl bg-white px-4 py-3 text-sm text-neutral-700 shadow-sm shadow-black/5">
                      <CheckCircle2 size={16} className="mt-0.5 shrink-0" />
                      <span>{item}</span>
                    </div>
                  ))}
              ...
              >
                <Card className="overflow-hidden rounded-3xl border-0 bg-white shadow-md shadow-black/5">
                  <div className="aspect-[4/3] p-3">
                    <ImageTile src={project.image} alt={project.title} className="rounded-2xl" />
                  </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-6 grid gap-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl bg-white/10 p-3 text-xs text-neutral-300 text-center">Before Photo</div>
                    <div className="rounded-xl bg-white/10 p-3 text-xs text-neutral-300 text-center">After Photo</div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl bg-white/10 p-3 text-xs text-neutral-300 text-center">Before Photo</div>
                    <div className="rounded-xl bg-white/10 p-3 text-xs text-neutral-300 text-center">After Photo</div>
                ...
                <div className="mt-6 space-y-3">
                  {recentProjects.map((item) => (
                    <div key={item} className="flex items-center gap-3 rounded-2xl bg-white/5 px-4 py-3 text-sm text-neutral-200">
            ...
            <Card id="about" className="rounded-[2rem] border-0 bg-neutral-100 shadow-md shadow-black/5">
              <CardContent className="p-8">
                ...
                <p className="mt-4 text-sm leading-7 text-neutral-600">
                  With over 25 years of experience in residential remodeling, HRM Building & Remodeling LLC has built a reputation for honest work, quality craftsmanship, and dependable service. We focus on kitchens, bathrooms, basements, decks, windows, and doors for homeowners throughout the Vernon area.
                </p>
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr]">
              ...
              {gallery.map((item) => (
                <Card key={item.title} className="overflow-hidden rounded-3xl border-0 shadow-md shadow-black/5">
                  <div className="aspect-square p-3">
                    <ImageTile src={item.image} alt={item.title} className="rounded-2xl" />
                  </div>
                  <CardContent className="px-5 pb-5 pt-0">
                    <div className="text-xs font-medium text-neutral-600">{item.title}</div>
                  </CardContent>
                </Card>
              ))}
            </div>
          ...
          <div className="rounded-[2rem] bg-neutral-950 p-8 text-white shadow-2xl">
            ...
            <p className="mt-5 text-sm leading-7 text-neutral-300">
              Every project we take on is built with the goal of creating a space that works better for your family and lasts for years. From kitchens and bathrooms to basements, decks, windows, and doors, we focus on thoughtful design, careful installation, and clear communication so homeowners feel confident from start to finish.
            </p>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {positioningPoints.map((point) => (
                <div key={point} className="flex items-start gap-3 rounded-xl bg-white/5 px-4 py-3 text-sm text-neutral-200">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Card className="rounded-[2rem] border-white/10 bg-white/5 text-white shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="mt-4 text-sm leading-7 text-neutral-300">
                  Homeowners want to know they are hiring a contractor they can trust. With decades of hands‑on experience and a focus on doing the job the right way, HRM Building & Remodeling approaches every project with careful workmanship, honest communication, and attention to detail from start to finish. Our goal is simple — create spaces that work better for your family and hold up for years to come.
                </p>
            ...
            <Card className="rounded-[2rem] border-white/10 bg-white/5 text-white shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="mt-4 text-sm leading-7 text-neutral-300">
                  This section is ready for a Google Reviews widget. Once you choose a provider such as Elfsight, EmbedSocial, or Taggbox, your embed code can be placed here so reviews update automatically.
                </p>
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  <Button className="rounded-xl bg-white px-5 py-4 text-sm text-black hover:bg-white/90">
                    Read Our Reviews
                  </Button>
                  <Button
                    variant="secondary"
                    className="rounded-xl border border-white bg-transparent px-5 py-4 text-sm text-white hover:bg-white/10"
                  >
                    Leave a Review
                  </Button>
                </div>
          ...
          <div className="grid gap-6 rounded-[2rem] border border-white/10 bg-white/5 p-8 md:grid-cols-[1fr_auto] md:items-center md:p-10">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-neutral-300">
                Serving Vernon, Ellington, Manchester, Tolland, South Windsor, Glastonbury, Rockville, and surrounding communities. Reach out today to request a free estimate and start planning your next home improvement project.
              </p>
            </div>
